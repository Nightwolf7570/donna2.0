...
export default function Sidebar({ currentView, onViewChange }: SidebarProps) {
  const { connected, checking, retry } = useConnectionStatus()
        ...
        <div className="card p-4">
          {checking ? (
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-[#a0a0b0]">Connecting...</span>
            </div>
          ) : connected ? (
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#a0a0b0]">Server online</p>
              </div>
            </div>
          ) : (
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-[#ef4444]">Disconnected</span>
              </div>
              <button onClick={retry} className="btn-secondary w-full text-sm">
                Retry Connection
              </button>
            </div>
          )}
